...
Namespace Grid_TopAverageCondition
    Partial Public Class Form1
        ...
        Public Sub New()
            ...
            topCondition.Rank = 3
            topCondition.StyleSettings =
                New IconSettings(FormatConditionIconType.IndicatorGreenCheck)
            ...
            bottomCondition.StyleSettings =
                New IconSettings(FormatConditionIconType.IndicatorRedFlag)
